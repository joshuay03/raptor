...
module Raptor
  class TestIntegrationHttp1 < IntegrationTestCase
    parallelize_me!
    ...
    def test_expect_100_continue_sent_before_body
      with_server("rack_input.ru") do |uri|
        ...
        expected = Http1::CONTINUE_RESPONSE
    ...
    def test_expect_100_continue_ignored_for_http10
      with_server("rack_input.ru") do |uri|
        ...
        assert_match(%r{\AHTTP/1\.[01] 200}, response)
        assert_includes response, "hello"
      end
    end
    ...
    def test_http10_connection_defaults_to_close
      with_server do |uri|
        ...
        assert_match(%r{HTTP/1\.0 200 OK}, response)
